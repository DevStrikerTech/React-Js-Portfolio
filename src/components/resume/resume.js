                        ...
                        <div className="nine columns main-col">
                            <div className="row item">
                                <div className="twelve columns">
                                    ...
                                    <p>
                                        ...
                                        enim.
                                        Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. Nullam
                            ...
                            <div className="row item">
                                <div className="twelve columns">
                                    ...
                                    <p className="info">B.A. Degree in Graphic Design <span>•</span> <em
                        ...
                        <div className="nine columns main-col">
                            <div className="row item">
                                <div className="twelve columns">
                                    ...
                                    <p className="info">Senior UX Designer <span>•</span> <em className="date">March
                                        2010 - Present</em></p>
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula
                                        eget dolor. Aenean massa.
